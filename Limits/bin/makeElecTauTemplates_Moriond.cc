	     ...
	     )
{
  ...
  TFile* fin_jDown   = new TFile(Form("/home/llr/cms/ivo/HTauTauAnalysis/CMSSW_5_3_4_Oct12/src/Bianchi/Limits/bin/results/histograms/%s/eTau_mH%d_%s_JetDown_%s.root", outputDir.Data(), 125, bin_.c_str() , variable_.c_str()), "READ");
  TFile* fin_tUp     = new TFile(Form("/home/llr/cms/ivo/HTauTauAnalysis/CMSSW_5_3_4_Oct12/src/Bianchi/Limits/bin/results/histograms/%s/eTau_mH%d_%s_TauUp_%s.root",   outputDir.Data(), 125, bin_.c_str() , variable_.c_str()), "READ");
  TFile* fin_tDown   = new TFile(Form("/home/llr/cms/ivo/HTauTauAnalysis/CMSSW_5_3_4_Oct12/src/Bianchi/Limits/bin/results/histograms/%s/eTau_mH%d_%s_TauDown_%s.root", outputDir.Data(), 125, bin_.c_str() , variable_.c_str()), "READ");
  TFile* fin_nominal = new TFile(Form("/home/llr/cms/ivo/HTauTauAnalysis/CMSSW_5_3_4_Oct12/src/Bianchi/Limits/bin/results/histograms/%s/eTau_mH%d_%s__%s.root",        outputDir.Data(), 125, bin_.c_str() , variable_.c_str()), "READ");
  ///////////////////////////////////////////////
  ...
  TFile* fTemplOut = new TFile(Form("/home/llr/cms/ivo/HTauTauAnalysis/CMSSW_5_3_4_Oct12/src/Bianchi/Limits/bin/results/datacards/%s/eTau%s.root",outputDir.Data(), theory.c_str()),"UPDATE");
  ...
  ofstream out(Form("/home/llr/cms/ivo/HTauTauAnalysis/CMSSW_5_3_4_Oct12/src/Bianchi/Limits/bin/results/datacards/%s/eTau_%s_m%s%d.txt", outputDir.Data(), binNameSpace.c_str(), resonance.c_str(), mH_ ));
  out.precision(8);
...
void produceAll(  TString outputDir = "2DFit/WithoutZFakes" ){
...
//        produce(mH[j],variables[i], "TauDown" , "vbf", outputDir);
       ...
       produce2DFit(mH[j],variables[i], ""        , "inclusive", outputDir);
       produce2DFit(mH[j],variables[i], "TauUp"   , "inclusive", outputDir);
       produce2DFit(mH[j],variables[i], "TauDown" , "inclusive", outputDir);
       produce2DFit(mH[j],variables[i], "JetUp"   , "inclusive", outputDir);
       produce2DFit(mH[j],variables[i], "JetDown" , "inclusive", outputDir);

       produce2DFit(mH[j],variables[i], ""        , "novbfLow", outputDir);
       produce2DFit(mH[j],variables[i], "TauUp"   , "novbfLow", outputDir);
       produce2DFit(mH[j],variables[i], "TauDown" , "novbfLow", outputDir);
       produce2DFit(mH[j],variables[i], "JetUp"   , "novbfLow", outputDir);
       produce2DFit(mH[j],variables[i], "JetDown" , "novbfLow", outputDir);

       produce2DFit(mH[j],variables[i], ""        , "novbfHigh", outputDir);
       produce2DFit(mH[j],variables[i], "TauUp"   , "novbfHigh", outputDir);
       produce2DFit(mH[j],variables[i], "TauDown" , "novbfHigh", outputDir);
       produce2DFit(mH[j],variables[i], "JetUp"   , "novbfHigh", outputDir);
       produce2DFit(mH[j],variables[i], "JetDown" , "novbfHigh", outputDir);

       produce2DFit(mH[j],variables[i], ""        , "boostLow", outputDir);
       produce2DFit(mH[j],variables[i], "TauUp"   , "boostLow", outputDir);
       produce2DFit(mH[j],variables[i], "TauDown" , "boostLow", outputDir);
       produce2DFit(mH[j],variables[i], "JetUp"   , "boostLow", outputDir);
       produce2DFit(mH[j],variables[i], "JetDown" , "boostLow", outputDir);
 
       produce2DFit(mH[j],variables[i], ""        , "boostHigh", outputDir);
       produce2DFit(mH[j],variables[i], "TauUp"   , "boostHigh", outputDir);
       produce2DFit(mH[j],variables[i], "TauDown" , "boostHigh", outputDir);
       produce2DFit(mH[j],variables[i], "JetUp"   , "boostHigh", outputDir);
       produce2DFit(mH[j],variables[i], "JetDown" , "boostHigh", outputDir);

       produce2DFit(mH[j],variables[i], ""        , "vbf", outputDir);
       produce2DFit(mH[j],variables[i], "TauUp"   , "vbf", outputDir);
       produce2DFit(mH[j],variables[i], "TauDown" , "vbf", outputDir);
       produce2DFit(mH[j],variables[i], "JetUp"   , "vbf", outputDir);
       produce2DFit(mH[j],variables[i], "JetDown" , "vbf", outputDir);
      }//DO2DFIT
