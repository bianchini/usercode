...
{   
  ...
  */
  ...
  TCut lID("((TMath::Abs(iscEta1)<0.80 && mvaPOGNonTrig>0.925) || (TMath::Abs(iscEta1)<1.479 && TMath::Abs(etaL1)>0.80 && mvaPOGNonTrig>0.975) || (TMath::Abs(iscEta1)>1.479 && mvaPOGNonTrig>0.985))");
  ...
  backgroundDYEtoTau->Draw(variable+">>hExtrap","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFTau*SFElec)"*sbinInclusive);
  ...
  backgroundDYJtoTau->Draw(variable+">>hExtrap","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFTau*SFElec)"*sbinInclusive);
  ...
  /*
  hExtrap->Reset();
  backgroundTTbar->Draw(variable+">>hExtrap","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelSSInclusive&&apZ&&TCut("nJets20BTagged>1")));
  float ExtrapttbarExtrSSBtag = hExtrap->Integral()*Lumi/1000*hltEff_*TTxsectionRatio;
  hExtrap->Reset();
  backgroundWJets->Draw(variable+">>hExtrap","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelSSInclusive&&apZ&&TCut("nJets20BTagged>1")));
  float ExtrapwjetsExtrSSBtag = hExtrap->Integral()*Lumi/1000*hltEff_;
  hExtrap->Reset();
  backgroundOthers->Draw(variable+">>hExtrap","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelSSInclusive&&apZ&&TCut("nJets20BTagged>1")));
  ...
  */
  ...
  hWMt->Reset();
  backgroundDYEtoTau->Draw(variable+">>hWMt","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelSS&&apZ));
  ...
  */
  ...
  for( unsigned iter=0; iter<samples.size(); iter++){
	...
	if((it->first).find("DYToTauTau")!=string::npos){
	  currentTree->Draw(variable+">>"+h1Name, "(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*sbinPZetaRelInclusive);  
	  float madgraphNoMEtCut = h1->Integral();
	  h1->Reset();
	  currentTree->Draw(variable+">>"+h1Name, "(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*sbinInclusive);
	  ...
	  if((selection_.find("vbf")!=string::npos && selection_.find("novbf")==string::npos) || selection_.find("twoJets")!=string::npos ){
	    ...
	    //currentTree->Draw(variable+">>"+h1Name,"(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinMtisoInclusive&&vbfLoose));
	    ...
	    hHelp->Reset();
	    backgroundWJets->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelInclusive&&apZ&&vbfLoose));
	    cout << hHelp->Integral() << endl;
	    float WJetsVBFSdb    = hHelp->Integral();
	    float WJetsVBFSdbInt = hHelp->GetEntries();
	    hHelp->Reset();
	    backgroundWJets->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelInclusive&&pZ&&vbfLoose));
	    ...
	    hHelp->Reset();
            backgroundWJets->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelInclusive&&vbfLoose));
            cout << hHelp->Integral() << endl;
	    ...
	    hHelp->Reset();
            backgroundWJets->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelInclusive&&apZ2&&vbfLoose));
            cout << hHelp->Integral() << endl;
            ...
            cout << "W3jets MC in VBF(rel): using " << WJetsVBFSdbInt2 << " events from sideband (2) and " << WJetsVBFSgnInt2 << " from signal region" << endl;
	    ...
	    hHelp->Reset();
            backgroundWJets->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelSSInclusive&&apZ2&&vbfLoose));
	    cout << hHelp->Integral() << endl;
            float WJetsVBFSdbSS    = hHelp->Integral();
            float WJetsVBFSdbIntSS = hHelp->GetEntries();
            hHelp->Reset();
            backgroundWJets->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelSSInclusive&&pZ&&vbfLoose));
	    float WJetsVBFSgnSS    = hHelp->Integral();
            float WJetsVBFSgnIntSS = hHelp->GetEntries();
            cout << "W3jets MC (SS) in VBF(rel): using " << WJetsVBFSdbIntSS << " events from sideband SS (2) and " << WJetsVBFSgnIntSS << " from signal region" << endl;
	    ...
	    /*
	    hHelp->Reset();
	    backgroundDYTauTau->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelInclusive&&apZ2&&vbf));
	    ...
	    hHelp->Reset();
	    backgroundDYEtoTau->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelInclusive&&apZ2&&vbf));
	    ...
	    hHelp->Reset();
	    backgroundDYJtoTau->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelInclusive&&apZ2&&vbf));
	    ...
	    */
	    hHelp->Reset();
	    backgroundOthers->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelInclusive&&apZ2&&vbf));
	    ...
	    backgroundTTbar->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelInclusive&&apZ2&&vbf));
	    ...
	    hHelp->Reset();
	    backgroundDYEtoTau->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelSSInclusive&&apZ2&&vbf));
	    ...
	    hHelp->Reset();
	    backgroundDYJtoTau->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelSSInclusive&&apZ2&&vbf));
	    ...
	    hHelp->Reset();
	    backgroundOthers->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelSSInclusive&&apZ2&&vbf));
	    ...
	    hHelp->Reset();
            ...
            hHelp->Reset();
            backgroundTTbar->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelSSInclusive&&apZ2&&vbf));
	    ...
	    hHelp->Reset();
	    backgroundDYEtoTau->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelSSInclusive&&pZ&&vbf));
	    ...
	    hHelp->Reset();
	    backgroundDYJtoTau->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelSSInclusive&&pZ&&vbf));
	    ...
	    hHelp->Reset();
	    backgroundOthers->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelSSInclusive&&pZ&&vbf));
	    ...
	    hHelp->Reset();
            ...
            hHelp->Reset();
            backgroundTTbar->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelSSInclusive&&pZ&&vbf));
	    ...
	    currentTree->Draw(variable+">>"+h1Name,"(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*sbinLtiso);
	    hW3JetsLooseTauIso->Add(h1,1.0);
	  }
	  ...
	  if(selection_.find("bTag")!=string::npos){ 
            ...
            h1Help->Reset();
            currentTree->Draw(variable+">>h1Help","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinInclusive&&ExactOneJet20));
            ...
            // SIDEBAND OS
            hHelp->Reset();
            currentTree->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelInclusive&&apZ&&bTagLoose));
            cout << hHelp->Integral() << endl;
            float WJetsBTAGSdb    = hHelp->Integral();
            float WJetsBTAGSdbInt = hHelp->GetEntries();
            hHelp->Reset();
            currentTree->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelInclusive&&pZ&&bTagLoose));
            ...
            cout << " ==> ratio sdb/sgn = " <<  ExtrapFactorWJets << endl;
            hHelp->Reset();
            currentTree->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelInclusive&&bTag));
            cout << hHelp->Integral() << endl;
	    ...
	    // SIDEBAND2 OS 
            hHelp->Reset(); 
            currentTree->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelInclusive&&apZ2&&bTagLoose)); 
            cout << hHelp->Integral() << endl; 
	    ...
	    // SIDEBAND SS
            hHelp->Reset();
            currentTree->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelSSInclusive&&apZ2&&bTagLoose));
            cout << hHelp->Integral() << endl;
            float WJetsBTAGSdbSS    = hHelp->Integral();
            float WJetsBTAGSdbIntSS = hHelp->GetEntries();
            hHelp->Reset();
            currentTree->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelSSInclusive&&pZ&&bTagLoose));
	    ...
	    // now, normalize to sidebands
            ...
            hHelp->Reset();
            backgroundDYTauTau->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelInclusive&&apZ2&&bTag));
            ...
            hHelp->Reset();
            backgroundDYEtoTau->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelInclusive&&apZ2&&bTag));
	    ...
	    hHelp->Reset();
            backgroundDYJtoTau->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelInclusive&&apZ2&&bTag));
            ...
            hHelp->Reset();
            backgroundOthers->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelInclusive&&apZ2&&bTag));
            ...
            backgroundTTbar->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelInclusive&&apZ2&&bTag));
	    ...
	    cout << "Subtracting the backgrounds from the sideband..." << endl;
            ...
            hHelp->Reset();
            backgroundDYEtoTau->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelSSInclusive&&apZ2&&bTag));
	    ...
	    hHelp->Reset();
            backgroundDYJtoTau->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelSSInclusive&&apZ2&&bTag));
            ...
            hHelp->Reset();
            backgroundOthers->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelSSInclusive&&apZ2&&bTag));
            ...
            hHelp->Reset();
            backgroundTTbar->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelSSInclusive&&apZ2&&bTag));
	    ...
	    /*
            ...
            */
            ...
            hHelp->Reset();
            backgroundDYEtoTau->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelSSInclusive&&pZ&&bTag));
            ...
            hHelp->Reset();
            backgroundDYJtoTau->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelSSInclusive&&pZ&&bTag));
	    ...
	    hHelp->Reset();
            backgroundOthers->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelSSInclusive&&pZ&&bTag));
            ...
            hHelp->Reset();
            backgroundTTbar->Draw(variable+">>hHelp","(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau)"*(sbinPZetaRelSSInclusive&&pZ&&bTag));
	  ...
	  if( selection_.find("vbf")!=string::npos && selection_.find("novbf")==string::npos ){
            TH1F* hHelp = new TH1F( "hHelp" ,"" , nBins , bins.GetArray());
            currentTree->Draw(variable+">>hHelp", "(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau*HqTWeight)"*(sbinInclusive&&twoJets));
	...
	TH1F* hHelp = new TH1F( "hHelp" ,"" , nBins , bins.GetArray());
	currentTree->Draw(variable+">>hHelp", "(sampleWeight*puWeight*HLTweightTau*HLTweightElec*SFElec*SFTau*HqTWeight)"*sbinMtiso);
...
void plotElecTauAll( Int_t useEmbedded = 1, TString outputDir = "July2012/Thesis"){
  ...
  //plotElecTau(120,1,"inclusive",""   ,"MEtMVA","MET","GeV"                        ,outputDir,40,0,100,5.0,1.0,0,1.2);
  //plotElecTau(120,1,"inclusive",""   ,"MEtMVAPhi","MVA #phi","units"              ,outputDir,32,-3.2,3.2,   5.0,1.0,0,1.5);
  //plotElecTau(120,1,"inclusive",""   ,"MtLeg1MVA","M_{T}","GeV" ,                  outputDir,40,0,160,5.0,1.0,0,1.2);
