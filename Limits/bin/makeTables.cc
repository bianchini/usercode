...
void queryText( TString stream_ = "MuTau", TString outputDir_   = "Dec2011/iter3", string selection_ = "inclusive",
  ...
  is.open(Form("/home/llr/cms/lbianchini/CMSSW_4_2_5/src/Bianchi/Limits/htautau/histograms/%s/yields%s_mH120_%s_.txt",outputDir_.Data(),stream_.Data(),selection_.c_str()));
  if(is.is_open()) 
...
void makeTables( TString stream_ = "MuTau", TString outputDir_   = "Dec2011/iter3"){
  ...
  ofstream out(Form("/home/llr/cms/lbianchini/CMSSW_4_2_5/src/Bianchi/Limits/htautau/histograms/%s/yields%s.txt",outputDir_.Data(),stream_.Data()),ios_base::out); 
  out.precision(5);
