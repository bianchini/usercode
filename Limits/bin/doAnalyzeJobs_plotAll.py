...
def analyze(mH,category,analysis,variable,xtitle,unity,outputDir,nBins,xMin,xMax,magnify,hltEff,logy,maxY):
    ...
    f = open(fileJob,'w')    
    f.write('#!/bin/sh\n\n')
    f.write('export WORKINGDIR="'+release+'/src/Bianchi/Limits/bin/"\n')
    f.write('')
...
analyze(125,"inclusive",""   ,"MEtMVA","MET","GeV"                             ,outputDir,40,0,100,5.0,1.0,0,1.2);
analyze(125,"inclusive",""   ,"MEtMVAPhi","MET #phi","units"                   ,outputDir,32,-3.2,3.2,   5.0,1.0,0,1.5);
analyze(125,"inclusiveNoMt",""   ,"MtLeg1MVA","M_{T}(#mu#nu)","GeV"            ,outputDir,40,0,160,5.0,1.0,0,1.2);
analyze(125,"inclusive",""   ,"diTauVisMass","visible mass","GeV"              ,outputDir,50,0,200,5.0,1.0,0,1.2); 
analyze(125,"inclusive",""   ,"diTauNSVfitMass","SVfit mass","GeV"             ,outputDir,60,0,360,5.0,1.0,0,1.2);
analyze(125,"inclusive",""   ,"etaL1","#mu #eta", "units"                      ,outputDir,25,-2.5, 2.5,5.0,1.0,0,2.);
analyze(125,"inclusive",""   ,"ptL1","#mu p_{T}", "GeV"                        ,outputDir,27,11, 92,5.0,1.0,0,1.2);
analyze(125,"inclusive",""   ,"ptL2","#tau p_{T}","GeV"                        ,outputDir,27,11, 92,5.0,1.0,0,1.2);
analyze(125,"inclusive",""   ,"etaL2","#tau #eta","units"                      ,outputDir,25,-2.5, 2.5,5.0,1.0,0,2.);
...
analyze(125,"novbfLowNoMt",""   ,"MtLeg1MVA","M_{T}(#mu#nu)","GeV"             ,outputDir,16,0,160,5.0,1.0,0,1.2);
analyze(125,"novbfLow",""   ,"diTauVisMass","visible mass","GeV"               ,outputDir,20,0,200,5.0,1.0,0,1.2);  
analyze(125,"novbfLow",""   ,"diTauNSVfitMass","SVfit mass","GeV"              ,outputDir,-1,0,100,5.0,1.0,0,1.2);
analyze(125,"novbfLow",""   ,"etaL1","#mu #eta", "units"                       ,outputDir,10,-2.5, 2.5,5.0,1.0,0,2.);
analyze(125,"novbfLow",""   ,"ptL1","#mu p_{T}", "GeV"                         ,outputDir,16, 15, 95,5.0,1.0,0,1.2);
...
analyze(125,"novbfHighNoMt",""   ,"MtLeg1MVA","M_{T}(#mu#nu)","GeV"            ,outputDir,16,0,160,5.0,1.0,0,1.2);
...
analyze(125,"novbfHigh",""   ,"etaL1","#mu #eta", "units"                      ,outputDir,10,-2.5, 2.5,5.0,1.0,0,2.);
analyze(125,"novbfHigh",""   ,"ptL1","#mu p_{T}", "GeV"                        ,outputDir,16, 15, 95,5.0,1.0,0,1.2);
analyze(125,"novbfHigh",""   ,"ptL2","#tau p_{T}","GeV"                        ,outputDir,16, 15, 95,5.0,1.0,0,1.2);
analyze(125,"novbfHigh",""   ,"etaL2","#tau #eta","units"                      ,outputDir,10,-2.5, 2.5,5.0,1.0,0,2.);
...
analyze(125,"boostLowNoMt",""   ,"MtLeg1MVA","M_{T}(#mu#nu)","GeV"             ,outputDir,16,0,160,5.0,1.0,0,1.2);
analyze(125,"boostLow",""   ,"diTauVisMass","visible mass","GeV"               ,outputDir,20,0,200,5.0,1.0,0,1.2);  
analyze(125,"boostLow",""   ,"diTauNSVfitMass","SVfit mass","GeV"              ,outputDir,-1,0,100,5.0,1.0,0,1.2);
analyze(125,"boostLow",""   ,"etaL1","#mu #eta", "units"                       ,outputDir,10,-2.5, 2.5,5.0,1.0,0,2.);
analyze(125,"boostLow",""   ,"ptL1","#mu p_{T}", "GeV"                         ,outputDir,16, 15, 95,5.0,1.0,0,1.2);
analyze(125,"boostLow",""   ,"ptL2","#tau p_{T}","GeV"                         ,outputDir,16, 15, 95,5.0,1.0,0,1.2);
analyze(125,"boostLow",""   ,"etaL2","#tau #eta","units"                       ,outputDir,10,-2.5, 2.5,5.0,1.0,0,2.);
...
analyze(125,"boostHighNoMt",""   ,"MtLeg1MVA","M_{T}(#mu#nu)","GeV"            ,outputDir,16,0,160,5.0,1.0,0,1.2);
...
analyze(125,"boostHigh",""   ,"etaL1","#mu #eta", "units"                      ,outputDir,10,-2.5, 2.5,5.0,1.0,0,2.);
analyze(125,"boostHigh",""   ,"ptL1","#mu p_{T}", "GeV"                        ,outputDir,16, 15, 95,5.0,1.0,0,1.2);
analyze(125,"boostHigh",""   ,"ptL2","#tau p_{T}","GeV"                        ,outputDir,16, 15, 95,5.0,1.0,0,1.2);
analyze(125,"boostHigh",""   ,"etaL2","#tau #eta","units"                      ,outputDir,10,-2.5, 2.5,5.0,1.0,0,2.);
...
analyze(125,"vbfNoMt",""   ,"MtLeg1MVA","M_{T}(#mu#nu)","GeV"                  ,outputDir,16,0,160,5.0,1.0,0,1.2);
...
analyze(125,"vbf",""   ,"etaL1","#mu #eta", "units"                            ,outputDir,10,-2.5, 2.5,5.0,1.0,0, 2.);
analyze(125,"vbf",""   ,"ptL1","#mu p_{T}", "GeV"                              ,outputDir,16, 15, 95,5.0,1.0,0,1.2);
analyze(125,"vbf",""   ,"ptL2","#tau p_{T}","GeV"                              ,outputDir,16, 15, 95,5.0,1.0,0,1.2);
analyze(125,"vbf",""   ,"etaL2","#tau #eta","units"                            ,outputDir,10,-2.5, 2.5,5.0,1.0,0,2.);
