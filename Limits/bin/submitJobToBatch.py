...
def treeSkim( sample, xsection, runInSeries=False):
    ...
    if runInSeries:
        ...
        submitToQueue = '/opt/exp_soft/cms/t3/t3submit -q llr -k eo -N '+sample+' /home/llr/cms/lbianchini/CMSSW_4_2_8_patch7/src/Bianchi/Limits/bin/batch/job'+'_'+sample+'.sh > batch/'+sample+'.txt'
        print submitToQueue
