...
void produce(   
  ...
  fin = new TFile(Form("/home/llr/cms/veelken/ArunAnalysis/CMSSW_5_2_6_July12/src/Bianchi/Limits/htautau/histograms/%s/muTau_mH%d_%s_%s_%s.root", outputDir.Data(), 125, bin_.c_str() , analysisFile.c_str(), variable_.c_str()), "READ");


  ///////////////////////////////////////////////
  TFile* fin_jUp     = new TFile(Form("/home/llr/cms/veelken/ArunAnalysis/CMSSW_5_2_6_July12/src/Bianchi/Limits/htautau/histograms/%s/muTau_mH%d_%s_JetUp_%s.root",   outputDir.Data(), 125, bin_.c_str() , variable_.c_str()), "READ");
  TFile* fin_jDown   = new TFile(Form("/home/llr/cms/veelken/ArunAnalysis/CMSSW_5_2_6_July12/src/Bianchi/Limits/htautau/histograms/%s/muTau_mH%d_%s_JetDown_%s.root", outputDir.Data(), 125, bin_.c_str() , variable_.c_str()), "READ");
  TFile* fin_tUp     = new TFile(Form("/home/llr/cms/veelken/ArunAnalysis/CMSSW_5_2_6_July12/src/Bianchi/Limits/htautau/histograms/%s/muTau_mH%d_%s_TauUp_%s.root",   outputDir.Data(), 125, bin_.c_str() , variable_.c_str()), "READ");
  TFile* fin_tDown   = new TFile(Form("/home/llr/cms/veelken/ArunAnalysis/CMSSW_5_2_6_July12/src/Bianchi/Limits/htautau/histograms/%s/muTau_mH%d_%s_TauDown_%s.root", outputDir.Data(), 125, bin_.c_str() , variable_.c_str()), "READ");
  TFile* fin_nominal = new TFile(Form("/home/llr/cms/veelken/ArunAnalysis/CMSSW_5_2_6_July12/src/Bianchi/Limits/htautau/histograms/%s/muTau_mH%d_%s__%s.root",        outputDir.Data(), 125, bin_.c_str() , variable_.c_str()), "READ");
  ///////////////////////////////////////////////
  ...
  //TFile* fTemplOut = new TFile(Form("/home/llr/cms/veelken/ArunAnalysis/CMSSW_5_2_6_July12/src/Bianchi/Limits/htautau/datacards/%s/muTauSM_%s.root",outputDir.Data(), variable_.c_str()),"UPDATE");
  string theory =  !DOSUSY ? "SM" : "MSSM" ;

  TFile* fTemplOut = new TFile(Form("/home/llr/cms/veelken/ArunAnalysis/CMSSW_5_2_6_July12/src/Bianchi/Limits/htautau/datacards/%s/muTau%s.root",outputDir.Data(), theory.c_str()),"UPDATE");
  ...
  if(! (fTemplOut->cd( dirName.Data()  ) ) ){
    ...
    if(bin_.find("novbf")!=string::npos){
      ...
      TH1F* hQCD         = (TH1F*)fin->Get("hQCD");
      //TH1F* hLooseIso    = (TH1F*)fin->Get("hLooseIso2") ;   // <--------------- "hLooseIso2"
      TH1F* hLooseAntiIso   = (TH1F*)fin->Get("hDataAntiIsoLooseTauIso"); //shape with QCD sel. (2012)
      hLooseAntiIso->Scale(hQCD->Integral()/hLooseAntiIso->Integral());
      hLooseAntiIso->Write(Form("QCD%s"    ,suffix.c_str()));
	...
	TH1F* hW     = (TH1F*)fin->Get("hW");         // <---------------   hW 
      ...
      // QCD:  low-pt: SS data; high-pt: loose-iso data normalized to SS 
      TH1F* hQCD         = (TH1F*)fin->Get("hQCD");
      //TH1F* hLooseIso    = (TH1F*)fin->Get("hLooseIso") ;   // <------------------------ "hLooseIso"
      TH1F* hLooseAntiIso   = (TH1F*)fin->Get("hDataAntiIsoLooseTauIso"); //shape with QCD sel. (2012) 
      hLooseAntiIso->Scale(hQCD->Integral()/hLooseAntiIso->Integral()); 
      hLooseAntiIso->Write(Form("QCD%s"    ,suffix.c_str()));
	...
	//hW->Write(Form("W%s"    ,suffix.c_str()));
      ...
      */
      ...
      TH1F* hLooseIso3               = (TH1F*)fin->Get("hLooseIso3");
      ...
      hDataAntiIsoLooseTauIso->Scale(QCDfromSS/hDataAntiIsoLooseTauIso->Integral());  // <-----------------  THIS ONE
      hDataAntiIsoLooseTauIso->Write(Form("QCD%s"    ,suffix.c_str()));
      //hLooseIso3->Scale(QCDfromSS/hLooseIso3->Integral());
      //hLooseIso3->Write(Form("QCD%s"    ,suffix.c_str()));
      */
      //2012 (already scaled )
      ((TH1F*)fin->Get("hDataAntiIsoLooseTauIso"))->Write(Form("QCD%s"    ,suffix.c_str()));
	...
	*/
	...
	if( bin_.find("Low")!=string::npos )
	  ...
	  //TH1F* hW     = (TH1F*)fin->Get("hWLooseIso2");  
	  //TH1F* hWKeys = (TH1F*)fin->Get("hWKeys");
	  //hWKeys->Scale(hW->Integral()/hWKeys->Integral());
	  ////hWKeys->Write(Form("W%s"    ,suffix.c_str()));
	  //hW->Write(Form("W%s"    ,suffix.c_str()));    // <-------------- THIS ONE
	  ((TH1F*)fin->Get("hW"))->Write(Form("W%s"           ,suffix.c_str()));
	}
  ...
  in.open(Form("/home/llr/cms/veelken/ArunAnalysis/CMSSW_5_2_6_July12/src/Bianchi/Limits/htautau/templates/%s/muTau_%s_template_v3.txt", theory.c_str(),    binNameSpace.c_str()));
  //ofstream out(Form("/home/llr/cms/veelken/ArunAnalysis/CMSSW_5_2_6_July12/src/Bianchi/Limits/htautau/datacards/%s/muTau_%s_mH%d_%s.txt", outputDir.Data(), binNameSpace.c_str(), mH_, variable_.c_str()));
  string resonance = !DOSUSY ? "H" : "A";

  ofstream out(Form("/home/llr/cms/veelken/ArunAnalysis/CMSSW_5_2_6_July12/src/Bianchi/Limits/htautau/datacards/%s/muTau_%s_m%s%d.txt", outputDir.Data(), binNameSpace.c_str(), resonance.c_str(), mH_ ));
  out.precision(8);
...
void produceAll(  TString outputDir = "Sync23Sep2012" ){
