...
void cutFlowStudyMu( ) 
{
  ...
  TFile *fBackgroundDY
    = new TFile("/home/llr/cms/lbianchini/CMSSW_4_2_5/src/Bianchi/TauTauStudies/test/Macro/skimLog/MuTauStream/DYJets/skimMuTauStream.root","READ"); 
  TFile *fBackgroundW   
    = new TFile("/home/llr/cms/lbianchini/CMSSW_4_2_5/src/Bianchi/TauTauStudies/test/Macro/skimLog/MuTauStream/W/skimMuTauStream.root","READ"); 
  TFile *fBackgroundTT  
    = new TFile("/home/llr/cms/lbianchini/CMSSW_4_2_5/src/Bianchi/TauTauStudies/test/Macro/skimLog/MuTauStream/TT/skimMuTauStream.root","READ"); 
  TFile *fBackgroundVBF120  
    = new TFile("/home/llr/cms/lbianchini/CMSSW_4_2_5/src/Bianchi/TauTauStudies/test/Macro/skimLog/MuTauStream/VBF120/skimMuTauStream.root","READ"); 
