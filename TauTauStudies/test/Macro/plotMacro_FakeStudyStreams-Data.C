...
{   
  ...
  TString fSignalNameVBF           = "/data_CMS/cms/lbianchini/VbfJetsStudy/OpenNtuples/MuTauStream2011/v3/nTupleVBFH115-Mu-powheg-PUS1_Open_MuTauStream.root";
  TString fSignalNameGGH           = "/data_CMS/cms/lbianchini/VbfJetsStudy/OpenNtuples/MuTauStream2011/v3/nTupleGGFH115-Mu-powheg-PUS1_Open_MuTauStream.root";
  TString fBackgroundNameDYTauTau  = "/data_CMS/cms/lbianchini/VbfJetsStudy/OpenNtuples/MuTauStream2011/v3/nTupleDYJets-Mu-50-madgraph-PUS1_Open_MuTauStream.root";
  TString fBackgroundNameDYMuMu    = "/data_CMS/cms/lbianchini/VbfJetsStudy/OpenNtuples/MuTauStream2011/v3/nTupleDYJets-Mu-50-madgraph-PUS1_Open_MuTauStream.root";
  TString fBackgroundNameWJets     = "/data_CMS/cms/lbianchini/VbfJetsStudy/OpenNtuples/MuTauStream2011/v3/nTupleWJets-Mu-madgraph-PUS1_Open_MuTauStream.root";
  TString fBackgroundNameQCD       = "/data_CMS/cms/lbianchini/VbfJetsStudy/OpenNtuples/MuTauStream2011/v3/nTupleQCDmu_Open_MuTauStream.root";
  TString fBackgroundNameTTbar     = "/data_CMS/cms/lbianchini/VbfJetsStudy/OpenNtuples/MuTauStream2011/v3/nTupleTTJets-Mu-madgraph-PUS1_Open_MuTauStream.root";
  TString fBackgroundNameDiBoson   = "/data_CMS/cms/lbianchini/VbfJetsStudy/OpenNtuples/MuTauStream2011/v3/nTupleDiBoson-Mu_Open_MuTauStream.root";
...
void doAllPlotsMuTauStream(){
  ...
  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && combRelIsoLeg1<0.1 && tightestHPSWP>0 && diTauCharge==0 &&  MtLeg1<40","diTauSVFitMass","full mass","GeV",22,0,350,1,1);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_FullMassAllCuts.png");
  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && combRelIsoLeg1<0.1 && tightestHPSWP>0 && diTauCharge==0 &&  MtLeg1<40","diTauSVFitMass","full mass","GeV",22,0,350,1,0);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_FullMassAllCuts_Lin.png");

  return;

  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && (combRelIsoLeg1<0.10) && tightestHPSWP>0 && MtLeg1<40 && diTauCharge==0","pt1_","p_{T}^{j1}","GeV",20,0,200,1,0);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_pt1AllCuts.png");
  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && (combRelIsoLeg1<0.10) && tightestHPSWP>0 && MtLeg1<40 && diTauCharge==0","pt2_","p_{T}^{j2}","GeV",10,0,100,1,0);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_pt2AllCuts.png");
  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && (combRelIsoLeg1<0.10) && tightestHPSWP>0 && MtLeg1<40 && diTauCharge==0","Mjj_","M_{j1,j2}","GeV",20,0,800,1,0);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_MjjAllCuts.png");
  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && (combRelIsoLeg1<0.10) && tightestHPSWP>0 && MtLeg1<40 && diTauCharge==0","Deta_","#Delta#eta_{j1,j2}","unities",20,0,10,1,0);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_DetaAllCuts.png");
  ...
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_visibleMassEleIso.png");
  ...
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_visibleMassEleIsoTauISo.png");
  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && (combRelIsoLeg1<0.10) && tightestHPSWP>0 && MtLeg1<40","diTauVisMass","visible mass ","GeV",15,0,200,1,0);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_visibleMassEleIsoTauISoMt.png");
  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && (combRelIsoLeg1<0.10) && tightestHPSWP>0 && MtLeg1<40 && diTauCharge==0","diTauVisMass","visible mass ","GeV",15,0,200,1,0);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_visibleMassEleIsoTauISoMtOS.png");
  
  //fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",0.41,"pt1>0 && (combRelIsoLeg1<0.10) && tightestHPSWP>0 && MtLeg1<40 && diTauCharge==0","diTauVisMass","visible mass ","GeV",15,0,200,1,0);
  //if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_visibleMassEleIsoTauISoMtOSVBF.png");
  ...
  //if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_visibleMassEleIsoTauISoMtOSVBFJetVeto.png");

  ////////////////////////////////////////////////////////////////////////////////////////

  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && (combRelIsoLeg1<0.10) && tightestHPSWP>0 && MtLeg1<40 && diTauCharge==0","pt1_","p_{T}^{j1}","GeV",20,0,200,1,1);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_pt1AllCuts_log.png");
  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && (combRelIsoLeg1<0.10) && tightestHPSWP>0 && MtLeg1<40 && diTauCharge==0","pt2_","p_{T}^{j2}","GeV",20,0,200,1,1);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_pt2AllCuts_log.png");
  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && (combRelIsoLeg1<0.10) && tightestHPSWP>0 && MtLeg1<40 && diTauCharge==0","Mjj_","M_{j1,j2}","GeV",20,0,800,1,1);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_MjjAllCuts_log.png");
  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && (combRelIsoLeg1<0.10) && tightestHPSWP>0 && MtLeg1<40 && diTauCharge==0","Deta_","#Delta#eta_{j1,j2}","unities",20,0,10,1,1);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_DetaAllCuts_log.png");
  ...
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_visibleMassEleIso_log.png");
  ...
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_visibleMassEleIsoTauISo_log.png");
  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && (combRelIsoLeg1<0.10) && tightestHPSWP>0 && MtLeg1<40","diTauVisMass","visible mass ","GeV",15,0,200,1,1);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_visibleMassEleIsoTauISoMt_log.png");
  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && (combRelIsoLeg1<0.10) && tightestHPSWP>0 && MtLeg1<40 && diTauCharge==0","diTauVisMass","visible mass ","GeV",15,0,200,1,1);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_visibleMassEleIsoTauISoMtOS_log.png");
  ...
  //if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_visibleMassEleIsoTauISoMtOSVBF_log.png");
  ...
  //if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_visibleMassEleIsoTauISoMtOSVBFJetVeto_log.png");
...
void doAllPlotsMuTauStreamHLT(){
  ...
  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && (combRelIsoLeg1<0.10) && tightestHPSWP>0 && MtLeg1<40 && diTauCharge==0 && (HLT==1 || HLT==2)","pt1_","p_{T}^{j1}","GeV",20,0,200,1,0);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_pt1AllCuts.png");
  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && (combRelIsoLeg1<0.10) && tightestHPSWP>0 && MtLeg1<40 && diTauCharge==0 && (HLT==1 || HLT==2)","pt2_","p_{T}^{j2}","GeV",10,0,100,1,0);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_pt2AllCuts.png");
  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && (combRelIsoLeg1<0.10) && tightestHPSWP>0 && MtLeg1<40 && diTauCharge==0 && (HLT==1 || HLT==2)","Mjj_","M_{j1,j2}","GeV",20,0,800,1,0);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_MjjAllCuts.png");
  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && (combRelIsoLeg1<0.10) && tightestHPSWP>0 && MtLeg1<40 && diTauCharge==0 && (HLT==1 || HLT==2)","Deta_","#Delta#eta_{j1,j2}","unities",20,0,10,1,0);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_DetaAllCuts.png");


  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && (combRelIsoLeg1<0.10) && (HLT==1 || HLT==2)","diTauVisMass","visible mass ","GeV",20,0,200,1,0);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_visibleMassEleIso.png");
  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && (combRelIsoLeg1<0.10) && tightestHPSWP>0 && (HLT==1 || HLT==2)","diTauVisMass","visible mass ","GeV",20,0,200,1,0);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_visibleMassEleIsoTauISo.png");
  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && (combRelIsoLeg1<0.10) && tightestHPSWP>0 && MtLeg1<40 && (HLT==1 || HLT==2)","diTauVisMass","visible mass ","GeV",15,0,200,1,0);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_visibleMassEleIsoTauISoMt.png");
  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && (combRelIsoLeg1<0.10) && tightestHPSWP>0 && MtLeg1<40 && diTauCharge==0 && (HLT==1 || HLT==2)","diTauVisMass","visible mass ","GeV",15,0,200,1,0);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_visibleMassEleIsoTauISoMtOS.png");
  ...
  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && (combRelIsoLeg1<0.10) && tightestHPSWP>0 && MtLeg1<40 && diTauCharge==0 && (HLT==1 || HLT==2)","pt1_","p_{T}^{j1}","GeV",20,0,200,1,1);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_pt1AllCuts_log.png");
  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && (combRelIsoLeg1<0.10) && tightestHPSWP>0 && MtLeg1<40 && diTauCharge==0 && (HLT==1 || HLT==2)","pt2_","p_{T}^{j2}","GeV",20,0,200,1,1);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_pt2AllCuts_log.png");
  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && (combRelIsoLeg1<0.10) && tightestHPSWP>0 && MtLeg1<40 && diTauCharge==0 && (HLT==1 || HLT==2)","Mjj_","M_{j1,j2}","GeV",20,0,800,1,1);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_MjjAllCuts_log.png");
  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && (combRelIsoLeg1<0.10) && tightestHPSWP>0 && MtLeg1<40 && diTauCharge==0 && (HLT==1 || HLT==2)","Deta_","#Delta#eta_{j1,j2}","unities",20,0,10,1,1);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_DetaAllCuts_log.png");


  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && (combRelIsoLeg1<0.10) && (HLT==1 || HLT==2)","diTauVisMass","visible mass ","GeV",20,0,200,1,1);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_visibleMassEleIso_log.png");
  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && (combRelIsoLeg1<0.10) && tightestHPSWP>0 && (HLT==1 || HLT==2)","diTauVisMass","visible mass ","GeV",20,0,200,1,1);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_visibleMassEleIsoTauISo_log.png");
  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && (combRelIsoLeg1<0.10) && tightestHPSWP>0 && MtLeg1<40 && (HLT==1 || HLT==2)","diTauVisMass","visible mass ","GeV",15,0,200,1,1);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_visibleMassEleIsoTauISoMt_log.png");
  fakeStudyMu("TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",-1,"pt1>0 && (combRelIsoLeg1<0.10) && tightestHPSWP>0 && MtLeg1<40 && diTauCharge==0 && (HLT==1 || HLT==2)","diTauVisMass","visible mass ","GeV",15,0,200,1,1);
  if(SAVE) gPad->SaveAs("plot_MuTauStream_Data_visibleMassEleIsoTauISoMtOS_log.png");
