...
void cutFlowStudyElec( TString weightFile = "TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",
		       Double_t effS_ = 0.41, Double_t hltEff_ = 0.8) 
{
  
  ofstream out("cutFlow-ElecTauStream-MadGraph-Data.txt");
  out.precision(4);
  ...
  for(it = fullMap.begin(); it != fullMap.end(); it++){
    ...
    TCut cut =  (crossSec[it->first]>=0) ?  "(diTauLegsP4[0].Pt()>17 &&( (abs(diTauLegsP4[0].Eta())<1.5 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.08) || (abs(diTauLegsP4[0].Eta())>1.5 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.04)))"
      : "weight*(diTauLegsP4[0].Pt()>17 &&((abs(diTauLegsP4[0].Eta())<1.5 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.08) || (abs(diTauLegsP4[0].Eta())>1.5 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.04)))";
  ...
  for(it = fullMap.begin(); it != fullMap.end(); it++){
    ...
    float totalEvents = allEvents->GetBinContent(1);
    TH1F* h1 = new TH1F("h1","",1,-10,10); 
    TCut cut =  (crossSec[it->first]>=0) ?  "(diTauLegsP4[0].Pt()>17 && ((abs(diTauLegsP4[0].Eta())<1.5 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.08) || (abs(diTauLegsP4[0].Eta())>1.5 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.04)) && tightestHPSWP>0)"
      : "weight*((diTauLegsP4[0].Pt()>17 &&((abs(diTauLegsP4[0].Eta())<1.5 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.08) || (abs(diTauLegsP4[0].Eta())>1.5 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.04)) && tightestHPSWP>0))";
  ...
  for(it = fullMap.begin(); it != fullMap.end(); it++){
    ...
    float totalEvents = allEvents->GetBinContent(1);
    TH1F* h1 = new TH1F("h1","",1,-10,10); 
    TCut cut =  (crossSec[it->first]>=0) ?  "(diTauLegsP4[0].Pt()>17 && ((abs(diTauLegsP4[0].Eta())<1.5 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.08) || (abs(diTauLegsP4[0].Eta())>1.5 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.04)) && tightestHPSWP>0 && MtLeg1<40)"
      : "weight*((diTauLegsP4[0].Pt()>17 && ((abs(diTauLegsP4[0].Eta())<1.5 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.08) || (abs(diTauLegsP4[0].Eta())>1.5 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.04)) && tightestHPSWP>0 && MtLeg1<40))";
  ...
  for(it = fullMap.begin(); it != fullMap.end(); it++){
    ...
    float totalEvents = allEvents->GetBinContent(1);
    TH1F* h1 = new TH1F("h1","",1,-10,10); 
    TCut cut =  (crossSec[it->first]>=0) ?  "(diTauLegsP4[0].Pt()>17 && ((abs(diTauLegsP4[0].Eta())<1.5 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.08) || (abs(diTauLegsP4[0].Eta())>1.5 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.04)) && tightestHPSWP>0 && diTauCharge==0 && MtLeg1<40)"
      : "weight*((diTauLegsP4[0].Pt()>17 && ((abs(diTauLegsP4[0].Eta())<1.5 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.08) || (abs(diTauLegsP4[0].Eta())>1.5 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.04)) && tightestHPSWP>0 && diTauCharge==0 && MtLeg1<40))";
    TCut isRealTau = "isTauLegMatched>0.5";
    if((it->first).find("ZfakeTau")!=string::npos) cut = cut && (!isRealTau);
    else if((it->first).find("Ztautau")!=string::npos) cut = cut && (isRealTau);
  ...
  for(it = fullMap.begin(); it != fullMap.end(); it++){
    ...
    float totalEvents = allEvents->GetBinContent(1);
    TH1F* h1 = new TH1F("h1","",1,-10,10); 
    TCut cut =  (crossSec[it->first]>=0) ?  "(diTauLegsP4[0].Pt()>17 && ((abs(diTauLegsP4[0].Eta())<1.5 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.08) || (abs(diTauLegsP4[0].Eta())>1.5 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.04)) && tightestHPSWP>0 && diTauCharge==0 && MtLeg1<40 && jetsIDP4@.size()>1 && jetsIDP4[0].Et()>20 && jetsIDP4[1].Et()>15)"
      : "weight*((diTauLegsP4[0].Pt()>17 && ((abs(diTauLegsP4[0].Eta())<1.5 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.08) || (abs(diTauLegsP4[0].Eta())>1.5 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.04)) && tightestHPSWP>0 && diTauCharge==0 && MtLeg1<40 && jetsIDP4@.size()>1 && jetsIDP4[0].Et()>20 && jetsIDP4[1].Et()>15))";
  ...
  for(jt = tMap.begin(); jt != tMap.end(); jt++){
    cout<<jt->first<<endl;
    TH1F* h1 = new TH1F("h1","",1,-10,10); 
    TCut cut =  "sampleWeight*(ptL1>17 && pt1>0 && ((abs(etaL1)<1.5 && combRelIsoLeg1<0.08) || (abs(etaL1)>1.5 && combRelIsoLeg1<0.04)) && tightestHPSWP>0 && diTauCharge==0 && MtLeg1<40)"; 
  ...
  for(jt = tMap.begin(); jt != tMap.end(); jt++){
    cout<<jt->first<<endl;
    TCut cut =  "(ptL1>17 && pt1>0 && ((abs(etaL1)<1.5 && combRelIsoLeg1<0.08) || (abs(etaL1)>1.5 && combRelIsoLeg1<0.04)) && tightestHPSWP>0 && diTauCharge==0 && MtLeg1<40)"; 
	...
	std::cout << (jt->first) << " ---> processing event: " << ievt << " ..." <<std::endl;
      ...
      if((jt->first).find("Data")==string::npos) sampleWeight *= (Lumi/1000*hltEff_); 
...
void cutFlowStudyMu( TString weightFile = "TMVAClassificationPtOrd_qqH115vsWZttQCD_Cuts.weights.xml",
		     Double_t effS_ = 0.41, Double_t hltEff_=1.0) 
{
  ...
  for(it = fullMap.begin(); it != fullMap.end(); it++){
    ...
    float totalEvents = allEvents->GetBinContent(1);
    TH1F* h1 = new TH1F("h1","",1,-10,10); 
    TCut cut =  (crossSec[it->first]>=0) ?  "(diTauLegsP4[0].Pt()>17 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.1)"
      : "weight*((diTauLegsP4[0].Pt()>17 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.1))";
  ...
  for(it = fullMap.begin(); it != fullMap.end(); it++){
    ...
    float totalEvents = allEvents->GetBinContent(1);
    TH1F* h1 = new TH1F("h1","",1,-10,10); 
    TCut cut =  (crossSec[it->first]>=0) ?  "(diTauLegsP4[0].Pt()>17 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.1 && tightestHPSWP>0)"
      : "weight*((diTauLegsP4[0].Pt()>17 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.1 && tightestHPSWP>0))";
  ...
  for(it = fullMap.begin(); it != fullMap.end(); it++){
    ...
    float totalEvents = allEvents->GetBinContent(1);
    TH1F* h1 = new TH1F("h1","",1,-10,10); 
    TCut cut =  (crossSec[it->first]>=0) ?  "(diTauLegsP4[0].Pt()>17 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.1 && tightestHPSWP>0 && MtLeg1<40)"
      : "weight*((diTauLegsP4[0].Pt()>17 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.1 && tightestHPSWP>0 && MtLeg1<40))";
  ...
  for(it = fullMap.begin(); it != fullMap.end(); it++){
    ...
    float totalEvents = allEvents->GetBinContent(1);
    TH1F* h1 = new TH1F("h1","",1,-10,10); 
    TCut cut =  (crossSec[it->first]>=0) ?  "(diTauLegsP4[0].Pt()>17 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.1 && tightestHPSWP>0 && diTauCharge==0 && MtLeg1<40)"
      : "weight*((diTauLegsP4[0].Pt()>17 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.1 && tightestHPSWP>0 && diTauCharge==0 && MtLeg1<40))";
  ...
  for(it = fullMap.begin(); it != fullMap.end(); it++){
    ...
    float totalEvents = allEvents->GetBinContent(1);
    TH1F* h1 = new TH1F("h1","",1,-10,10); 
    TCut cut =  (crossSec[it->first]>=0) ?  "(diTauLegsP4[0].Pt()>17 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.1 && tightestHPSWP>0 && diTauCharge==0 && MtLeg1<40 && jetsIDP4@.size()>1 && jetsIDP4[0].Et()>20 && jetsIDP4[1].Et()>15)"
      : "weight*((diTauLegsP4[0].Pt()>17 && (chIsoLeg1+nhIsoLeg1+phIsoLeg1)/diTauLegsP4[0].Pt()<0.1 && tightestHPSWP>0 && diTauCharge==0 && MtLeg1<40 && jetsIDP4@.size()>1 && jetsIDP4[0].Et()>20 && jetsIDP4[1].Et()>15))";
  ...
  for(jt = tMap.begin(); jt != tMap.end(); jt++){
    cout<<jt->first<<endl;
    TH1F* h1 = new TH1F("h1","",1,-10,10); 
    TCut cut =  "sampleWeight*(ptL1>17 && pt1>0 && combRelIsoLeg1<0.1 && tightestHPSWP>0 && diTauCharge==0 && MtLeg1<40)"; 
    jt->second->Draw("etaL1>>h1",cut);
    if((jt->first).find("Data")==string::npos) h1->Scale(Lumi/1000*hltEff_); 
    float tot = h1->Integral();
    float totalEquivalentEvents = h1->GetEffectiveEntries();
  ...
  for(jt = tMap.begin(); jt != tMap.end(); jt++){
    cout<<jt->first<<endl;
    TCut cut =  "(ptL1>17 && pt1>0 && combRelIsoLeg1<0.1 && tightestHPSWP>0 && diTauCharge==0 && MtLeg1<40)"; 
