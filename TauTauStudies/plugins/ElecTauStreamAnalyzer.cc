...
void ElecTauStreamAnalyzer::analyze(const edm::Event & iEvent, const edm::EventSetup & iSetup){
  ...
  if(isMC_){
    ...
    HLTfiltersElec.push_back("hltOverlapFilterIsoEle20WP90LooseIsoPFTau20");
    HLTfiltersElec.push_back("hltOverlapFilterEle20LooseIsoPFTau20");
    HLTfiltersElec.push_back("hltOverlapFilterEle20WP90LooseIsoPFTau20");

    HLTfiltersTau.push_back("hltOverlapFilterIsoEle20LooseIsoPFTau20");
    HLTfiltersTau.push_back("hltOverlapFilterIsoEle20WP90LooseIsoPFTau20");
    HLTfiltersTau.push_back("hltOverlapFilterEle20LooseIsoPFTau20");
    HLTfiltersTau.push_back("hltOverlapFilterEle20WP90LooseIsoPFTau20");
  }
