...
mmBasic      = "(Vtype==2 && H.HiggsFlag==1)"
mmKin        = "(vLepton_pt[0]>30 && abs(vLepton_eta[0])<2.1)"
mmId         = "(vLepton_pfCorrIso[0]<0.10)"
mmJetBasic   = "(numJets30>=3 && pt1>30 && pt2>30 && pt3>30)"
...
process.fwliteInput = cms.PSet(
    ...
    cms.PSet(
    skip     = cms.bool(False),  
    name     = cms.string('WJetsToLNu_PtW-70To100_TuneZ2star_8TeV-madgraph'),
    nickName = cms.string('WJetsPt70100'),
    color    = cms.int32(19),
    xSec     = cms.double(37509.0*0.1418),
    ),

    cms.PSet(
    skip     = cms.bool(False),  
    name     = cms.string('WJetsToLNu_PtW-100_TuneZ2star_8TeV-madgraph'),
    nickName = cms.string('WJetsPt100'),
    color    = cms.int32(19),
    xSec     = cms.double(37509.0*0.1379),
    ),
    ...
    cut       = cms.string(common+" && numJets30==4 && pt4>30 && umJets30bTag==3"),
    logy      = cms.int32(1),
    ),
